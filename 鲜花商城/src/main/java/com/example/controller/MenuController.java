...
public class MenuController {
    ...
    public String getMenu(HttpServletRequest request) {
		...
		if (1 == level) {
			...
			array.add(getJsonObject("businessInfo", "店员信息", "layui-icon-table", "businessInfo"));
			array.add(getJsonObject("userInfo", "顾客信息", "layui-icon-table", "userInfo"));
			...
			array.add(getJsonObject("submitInfo", "提货报备", "layui-icon-table", "submitInfo"));
//			array.add(getJsonObject("richtextInfo", "防疫须知信息", "layui-icon-table", "richtextInfo"));
			...
			array.add(getJsonObject("typeInfo", "花束类型", "layui-icon-table", "typeInfo"));
			array.add(getJsonObject("goodsInfo", "花束详情管理", "layui-icon-table", "goodsInfo"));
